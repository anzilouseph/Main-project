...
# for w in words:
# 	print(w, " : ", ps.stem(w))
file = open(r'C:\Users\athul\PycharmProjects\mockinterview\interview\skill.csv',encoding='utf-8')
type(file)
