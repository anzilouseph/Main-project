...
(3,'pbkdf2_sha256$260000$GO9pA682o07SeNqUERJaxK$loWEV76pQ41FmY58okNCYoDbMNbE3MUhThnTkVmYqBg=','2024-02-12 12:43:45.036516',1,'admin','','','admin@gmail.com',1,1,'2024-01-27 08:00:19.681708');
...
(21,'interview','0003_alter_answer_details_vac_qn','2024-02-14 13:01:01.532553');
...
CREATE TABLE `interview_answer_details` (
  ...
  CONSTRAINT `interview_answer_det_vac_qn_id_164a0bbc_fk_interview` FOREIGN KEY (`vac_qn_id`) REFERENCES `interview_questions` (`id`),
...
insert  into `interview_answer_details`(`id`,`ans`,`emot`,`date`,`oans`,`user_id`,`vac_qn_id`) values 
(1,'no answer','neutral','2024-02-14','dhd',1,3),
(2,'no answer','neutral','2024-02-14','iwyeuf',1,3),
(3,'no answer','neutral','2024-02-14','cascading style sheet',1,3);
...
(3,'2024-02-12','hi',3,3),
(4,'2024-02-12','qwertyui',2,3),
(5,'2024-02-14','hii',3,2),
(6,'2024-02-14','hii',3,9);
...
(3,'abhishek','calicut',8899774455,'abcd123@gmail.com','',10);
...
(2,'jvyfg','pending','2024-02-13',1,1);
...
(1,'ayana','k','  calicut',7894562123,'ayana@gmail.com',4);
...
(4,'guide','123','guide'),
(9,'amal','amal','company'),
(10,'coompany','As@9846302305','pending'),
(12,'aaa','qwer','user'),
(13,'gxgx','hcgx','user');
...
(8,'what is css','cdfg','cascading style sheet','dfxgh','gcfbhjnj','cascading style sheet',3);
...
insert  into `interview_test_result`(`id`,`date`,`res`,`ans`,`USER_id`,`quetion_id`) values 
(1,'2024-02-13','0','ddg',1,1),
(2,'2024-02-13','0','isl',1,3),
(3,'2024-02-13','1','cascading style sheet',1,8);
...
insert  into `interview_upload`(`id`,`cv`,`date`,`USER_id`) values 
(1,'resume_Gr1VVyv.pdf','2024-02-14',1),
(2,'resume_9EgOhUB.pdf','2024-02-14',1);
...
(2,'jchc','','female','ufyf','jch',754657,9638526395,'naja@gmail.com','20240213_150615.jpg',13);
...
(3,'HR','normal','bsc,bca','2 year','20000','www',1);
